...
<div class="navbar">
  ...
  <div class="menu">
    ...
    <a href="locations_recommend.php" class="active" aria-current="page">สถานที่แนะนำ 📍</a>
    ...
    <div class="grid">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div style="margin-top:10px"><a class="btn" href="<?= h($mapUrl) ?>" target="_blank" rel="noopener">🗺️ เปิดใน Google Maps</a></div>
        </div>
      </div>
      <?php endforeach; ?>
    </div>
